...
const Mailing = ({ match }) => {
    return ( <
        ...
        Colxx xxs = "12" >
        <
        Breadcrumb heading = "menu.mailing"
        match = { match }
        /> <
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" valign="center" style="padding-bottom:40px;border-top:0;height:100% !important;width:100% !important;">
                                        <img src="https://coloredstrategies.com/mailing/Ana.png" />
                                    </td>
                                        ...
                                        <table>
                                                ...
                                                <td style="padding-bottom: 30px;">
                                                    <a href="#">
                                                        <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;"
                                                            src="https://Ana-react.coloredstrategies.com/img/carousels/1.jpg" />
                                                    </a>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 30px;">
                                                    <a href="#">
                                                        <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;"
                                                            src="https://Ana-react.coloredstrategies.com/img/carousels/2.jpg" />
                                                    </a>
                                                    <h4 style="font-size: 16px; line-height: 1; margin-bottom:5px; margin-top: 10px;"><a
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#">
                                                        <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;"
                                                            src="https://Ana-react.coloredstrategies.com/img/carousels/3.jpg" />
                                                    </a>
                                                    <h4 style="font-size: 16px; line-height: 1; margin-bottom:5px; margin-top: 10px;"><a
